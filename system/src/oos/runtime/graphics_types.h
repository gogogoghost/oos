...
#define OOS_WASM_ABI_VERSION 2u
...
enum OosTextureFlags {
  ...
  OOS_TEXTURE_REPEAT_X = 1u << 2,
  OOS_TEXTURE_REPEAT_Y = 1u << 3,
  OOS_TEXTURE_MIPMAPS = 1u << 4,
};

constexpr uint32_t OOS_TEXTURE_FLAGS_MASK =
    OOS_TEXTURE_LINEAR | OOS_TEXTURE_REPLACE | OOS_TEXTURE_REPEAT_X |
    OOS_TEXTURE_REPEAT_Y | OOS_TEXTURE_MIPMAPS;
